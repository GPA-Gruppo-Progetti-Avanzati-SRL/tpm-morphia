...
type CodeGenAttributeImpl struct {
	...
	AttrDefinition      schemaold.Field
...
func NewCodeGenCollection(aSchema *schemaold.Collection) (*CodeGenCollection, error) {
...
func NewAttribute(parentAttribute CodeGenAttribute, attrDefinition schemaold.Field, isArrayItem bool, prefix string /* , visitor NamespaceVisitor */) CodeGenAttribute {
...
func NewValueTypeAttribute(parentAttribute CodeGenAttribute, attrDefinition schemaold.Field, isArrayItem bool, prefix string /*, visitor NamespaceVisitor*/) CodeGenAttribute {
...
func NewRefStructTypeAttribute(parentAttribute CodeGenAttribute, attrDefinition schemaold.Field, isArrayItem bool, prefix string /*, visitor NamespaceVisitor*/) CodeGenAttribute {
...
func NewStructAttribute(parentAttribute CodeGenAttribute, attrDefinition schemaold.Field, isArrayItem bool, prefix string /*, visitor NamespaceVisitor */) CodeGenAttribute {
	s := &StructAttribute{}
...
func NewArrayAttribute(parentAttribute CodeGenAttribute, attrDefinition schemaold.Field, isArrayItem bool, prefix string /*, visitor NamespaceVisitor */) CodeGenAttribute {
	a := &ArrayAttribute{}
...
func NewMapAttribute(parentAttribute CodeGenAttribute, attrDefinition schemaold.Field, isArrayItem bool, prefix string /*, visitor NamespaceVisitor */) CodeGenAttribute {
	a := &MapAttribute{}
	a.AttrDefinition = attrDefinition
	a.ArrayItem = isArrayItem
	a.ParentAttribute = parentAttribute
...
func (c *CodeGenCollection) GetStructAttributes() []CodeGenAttribute {
	...
	for _, a := range c.Attributes {
		if a.GetDefinition().Typ == schemaold.AttributeTypeStruct {
			attrs = append(attrs, a)
		} else if a.GetDefinition().Typ == schemaold.AttributeTypeArray {
			i := a.(*ArrayAttribute).Item
			if i.GetDefinition().Typ == schemaold.AttributeTypeStruct {
				attrs = append(attrs, i)
			}
		} else if a.GetDefinition().Typ == schemaold.AttributeTypeMap {
...
func (b *CodeGenAttributeImpl) GetDefinition() schemaold.Field {
